...
await db.put({ _id: 'user1', asset: "BTC", quantity: 0.02, price: 66173.12, date: "01-01-2024" })
await db.put({ _id: 'user2', asset: "ETH", quantity: 0.54, price: 3400.12, date: "01-17-2024" })
await db.put({ _id: 'user3', asset: "SOL", quantity: 3, price: 187.12, date: "04-04-2024" })
await db.put({ _id: 'user4', asset: "SHIT", quantity: 3, price: 18.12, date: "04-04-2024" })
await db.put({ _id: 'user5', asset: "FARTK", quantity: 16.25, price: 69.69, date: "04-04-2024" })
await db.put({ _id: 'user6', asset: "MCKURZ", quantity: 100000, price: 0.0072, date: "04-05-2024" })
